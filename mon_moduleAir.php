...
<body>
  ...
  ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row" style="margin-top:20px;">
        <div class="col-sm-8">
          <a href="http://moduleair.fr">
          <img src="/img/logoModuleAirColor_long.png" height="50" alt="">
          </a>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">Mes données</h3>
                ...
                <p>Dernières mesures effectuées par le capteur ModuleAir.  <button type="button" onclick="refresh_data()" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-clockwise"></i></button>
                </p>
                ...
                <div class="col-sm">
                    ...
                    <div class="embed-responsive embed-responsive-4by3">
                      <iframe class="embed-responsive-item" id="co2_gauge" src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=co2&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&theme=light&panelId=8" height="200" frameborder="0"></iframe>
                    </div>
                  </div>
                  ...
                  <div class="col-sm">
                    <!-- PM1 -->
                    <div class="embed-responsive embed-responsive-4by3">
                      <iframe class="embed-responsive-item" id="pm1_gauge" src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=pm1&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&theme=light&panelId=10" height="200" frameborder="0"></iframe>
                    </div>
                  </div>
                  ...
                  <div class="col-sm">
                    <!-- PM2.5 -->
                    <div class="embed-responsive embed-responsive-4by3">
                      <iframe class="embed-responsive-item" id="pm25_gauge" src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=pm25&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&theme=light&panelId=12" height="200" frameborder="0"></iframe>
                    </div>
                  </div>
                  ...
                  <div class="col-sm">
                    <div class="embed-responsive embed-responsive-4by3">
                      <!-- PM10 -->
                      <iframe class="embed-responsive-item" id="pm10_gauge" src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=pm10&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&theme=light&panelId=14" height="200" frameborder="0"></iframe>
                    </div>
                  </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <div id="chart_PM">
                <iframe src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&panelId=6&theme=light" width="100%" height="600" frameborder="0"></iframe>
              </div>

              <div id="chart_co2">
                <iframe src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&panelId=4&theme=light" width="100%" height="600" frameborder="0"></iframe>
              </div>

              <div id="chart_COV">
                <iframe src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&panelId=29&theme=light" width="100%" height="600" frameborder="0"></iframe>
              </div>

              <div id="chart_temp_hum">
                <iframe src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&panelId=28&theme=light" width="100%" height="600" frameborder="0"></iframe>
              </div>

              <div id="chart_multi">
                <iframe src="https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-1h&to=now&panelId=26&theme=light" width="100%" height="600" frameborder="0"></iframe>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div id="search">
                <div class="mb-3 row">
                  <div class="col-8">
                    <input type="text" name="addr" value="" id="addr" class="form-control" placeholder="Entrez ici l'adresse ou se situe le ModuleAir ou déplacez le curseur sur la carte" />
                  </div>
                  <div class="col-4">
            ...
            <div class="card bg-dark text-white" style="border-radius: 1rem;">
              <div class="card-body p-5 text-center">
                ...
                <div class="mb-md-5 mt-md-4 pb-2">
                  ...
                  <h2 class="fw-bold mb-2">Mon Module Air</h2>
                  <p class="text-white-50 mb-5">Veuillez entrer le nom du ModuleAir ainsi que son token (indiqué au dos de l'appareil)</p>
  ...
  <script>
    ...
    function chooseTimeSpan(time) {
        document.getElementById("chart_PM").innerHTML = "<iframe src=\"https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-"+time+"h&to=now&panelId=6&theme=light\" width=\"100%\" height=\"600\" frameborder=\"0\"></iframe>";
      document.getElementById("chart_co2").innerHTML = "<iframe src=\"https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-"+time+"h&to=now&panelId=4&theme=light\" width=\"100%\" height=\"600\" frameborder=\"0\"></iframe>";
      document.getElementById("chart_COV").innerHTML = "<iframe src=\"https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-"+time+"h&to=now&panelId=29&theme=light\" width=\"100%\" height=\"600\" frameborder=\"0\"></iframe>";
      document.getElementById("chart_temp_hum").innerHTML = "<iframe src=\"https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-"+time+"h&to=now&panelId=28&theme=light\" width=\"100%\" height=\"600\" frameborder=\"0\"></iframe>";
      document.getElementById("chart_multi").innerHTML = "<iframe src=\"https://grafana.aircarto.fr/d-solo/7sgUpD44z/module-air-v2?orgId=1&var-compound=multi_mod&var-device=<?= $_SESSION['nom_device'] ?>&from=now-"+time+"h&to=now&panelId=26&theme=light\" width=\"100%\" height=\"600\" frameborder=\"0\"></iframe>";
